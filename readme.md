...
## Install Duitku Credit Card Switcher plugins through Composer
...
1. Install the plugins: `composer require duitku_payment_gateway/duitku_creadit_card_mg`
2. Enable the plugin:  `bin/magento module:enable Duitku_Creditcardmg`
...
6. Check the module status:  `bin/magento module:status Duitku_Creditcardmg`
...
## Install Duitku Credit Card Switcher plugins from Download file
...
5. Run this command on terminal
    ...
    `bin/magento module:enable Duitku_Creditcardmg`
    
    `bin/magento setup:upgrade`
    
    `bin/magento cache:clean`
    
    `bin/magento module:status Duitku_Creditcardmg`


# Plugin Usage Instruction
## Basic Plugins Configuration

Before you begin, make sure that you have successfully installed and enabled Duitku Credit Card Switcher plugins.
Configure the Duitku Credit Card Switcher plugin in your Magento admin panel: 
...
4. In the Other Payment Method section, click Duitku Credit Card Switcher to extend Basic Settings and fill out the following fields:
